...
import {  CLOSE_IMG_DIALOG_DELETE, OPEN_IMG_DIALOG } from 'src/app/events';
...
export class ImgDialogComponent {
  ...
  constructor(private hub: HubService, private intl: TranslateService, private eventPhotoService: EventphotoService){
